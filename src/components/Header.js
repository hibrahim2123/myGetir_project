...
function Header() {
  return (
    <div className="bg-[#5d3ebc]   ">
      <div className=" container mx-auto flex justify-center md:justify-between items-center h-16 md:h-10 ">
        <a href="">
          {" "}
          <img
        ...
        <nav className="hidden md:flex gap-8 text-sm font-semibold">
          <a
            href="#"
            className="flex items-center gap-1 text-white text-opacity-60 hover:text-opacity-100"
          >
            <TbWorld></TbWorld>
            Türkçe(TR)
          </a>
